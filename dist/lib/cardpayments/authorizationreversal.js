...
authorizationReversal.prototype.setAuthorization = function (authorization) {
...
authorizationReversal.prototype.setVoidAuths = function (voidAuths) {
...
authorizationReversal.prototype.setLinks = function (links) {
  this.links = links;
};
