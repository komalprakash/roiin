...
verification.prototype.setAccordD = function (accordD) {
...
verification.prototype.setMerchantDescriptor = function (merchantDescriptor) {
...
verification.prototype.setShippingDetails = function (shippingDetails) {
...
verification.prototype.setAuthentication = function (authentication) {
...
verification.prototype.setVerifications = function (verifications) {
...
verification.prototype.setLinks = function (links) {
  this.links = links;
};
