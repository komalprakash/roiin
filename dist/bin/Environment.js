 ...
 * author: Anup W.
 */
var Environment = function Environment(host, maxSocket, timeout) {
  this._host = host;
...
exports.SBOXTEST = new Environment("https://api.sbox.paysafe.com", 10, 30000); //module.exports = Environment;
